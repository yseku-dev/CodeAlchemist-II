...
const translationsData = {
  es: {
    ...
    "autoupdate": {
        ...
        "toast.downloadComplete.projectZipDescription": "Descarga ZIP (conteniendo JSON de cambios) iniciada. Este ZIP contiene un JSON con las rutas y el contenido sugerido para los archivos. No es un proyecto ejecutable.",
    ...
    "groups": {
        ...
        "form.orchestratorImplicitNote": "El OrquestadorFlujoAgentes se añade implícitamente.",
  ...
  en: {
    ...
    "autoupdate": {
        ...
        "toast.downloadComplete.projectZipDescription": "Project Download (ZIP containing JSON) initiated. This ZIP file contains a JSON detailing suggested file changes. It's not a full executable project.",
