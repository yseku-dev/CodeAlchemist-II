 ...
 * Using string for flexibility with dot-separated keys.
 */
  ...
  es: {
    ...
    "refactorProject": {
        ...
        "toast": {
            ...
            "fetchingGit": "Obteniendo contenido del repositorio Git...",
            "analyzingWithAI": "Analizando con IA...",
            "fileReadError": {
                "title": "Error de Lectura",
                "description": "No se pudo leer el archivo: {error}"
            },
            "gitFetchError": {
                "title": "Error al Obtener de Git",
                "unknown": "Error desconocido al obtener el repositorio."
            },
            "noContentToAnalyze": {
                "title": "Sin Contenido",
                "description": "No se encontró contenido para analizar en la fuente proporcionada."
            },
            "analysisComplete": {
    ...
    "generateProject": {
      ...
      "toast": {
        ...
        "zipDownloadSuccess": {
            ...
            "description": "Se ha descargado un archivo ZIP ({filename}) con la estructura y contenido del proyecto \"{projectName}\" generado por la IA."
        },
        "zipDownloadError": {
    ...
    "groups": {
        ...
        "form": {
            ...
            "descriptionModal": {
                 "edit": "Modifica los detalles del grupo de trabajo \"{name}\".",
                 "create": "Define un nuevo equipo de agentes para tareas colaborativas."
            },
            "label": {
                "name": "Nombre",
                "description": "Descripción",
  ...
  en: {
    ...
    "autoupdate": {
        ...
        "logs": {
            ...
            "projectZipDownloaded": "Suggestions Downloaded (ZIP Format Containing JSON). A .zip file has been downloaded. Important: This ZIP file contains a single JSON file with the code suggestions. It is not a ZIP of the complete project with a folder structure. To get the full project, you would need to clone it from its Git repository and manually apply the downloaded suggestions.",
    ...
    "refactorProject": {
        ...
        "priorityNone": "Ninguna",
        "priorities": {
          "PriorizarSeguridad": "Priorizar Seguridad",
          "PriorizarLegibilidad": "Priorizar Legibilidad",
          "PriorizarRendimiento": "Priorizar Rendimiento",
          "EstandarizarCódigo": "Estandarizar Código",
          "ReducirComplejidad": "Reducir Complejidad"
        },
        "depthLabel": "Profundidad de Búsqueda (opcional)",
        "depthPlaceholder": "Ej: 3 (niveles)",
        "focusLabel": "Campo de Enfoque del Análisis (opcional)",
  ...
  en: {
    ...
    "analyzeProject": {
        ...
        "toast": {
            ...
            "fetchingGit": "Fetching Git repository content...",
            "gitFetchError": {
                "title": "Error Fetching from Git",
                "unknown": "Unknown error fetching repository."
            }
        }
    },
    "generateCode": {
    ...
    "generateProject": {
      ...
      "toast": {
        ...
        "zipDownloadSuccess": {
            ...
            "description": "A ZIP file ({filename}) with the AI-generated project structure and content for \"{projectName}\" has been downloaded."
        },
        "zipDownloadError": {
    ...
    "groups": {
        ...
        "form": {
            ...
            "descriptionModal": {
                 "edit": "Modify details for workgroup \"{name}\".",
                 "create": "Define a new team of agents for collaborative tasks."
            },
            "label": {
                "name": "Name",
                "description": "Description",
